...
public class ASTConverter {
    ...
    private Node convert(Tree tree) {
        ...
        case SimpleCLexer.BNOT:
            return new UnaryExpr(tree.getType(),
                    (Expr) convert(tree.getChild(0)), dummyNode);
        ...
        case SimpleCLexer.SUBTRACT:
            return new BinaryExpr(tree.getType(),
                    ...
                    (Expr) convert(tree.getChild(1)), dummyNode);
        ...
        case SimpleCLexer.ASSIGNMENT:
            return new AssignStmt((DeclRef) convert(tree.getChild(0)),
                    (Expr) convert(tree.getChild(1)), dummyNode);
        case SimpleCLexer.BLOCK:
            return new BlockStmt((StmtList) convert(tree.getChild(0)),
                    dummyNode);
        ...
        case SimpleCLexer.DECL:
            return new Decl(tree.getChild(0).getText(), tree.getChild(1)
                    .getText(), dummyNode);
