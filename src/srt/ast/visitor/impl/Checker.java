...
/**
 * This class uses a Visitor to check that variables are declared before use and
 * that there are no duplicate local variables in the same scope.
 */
