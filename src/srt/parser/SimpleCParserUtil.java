...
public class SimpleCParserUtil {
     ...
     * 
     * @param filepath
     *            Path of the SimpleC program to parse.
     * @return The root of the AST, the token of which will be of type
     *         {@code SimpleCLexer.PROGRAM}.
     * @throws IOException
     *             Related to reading of the file.
     * @throws RecognitionException
     *             Related to parsing.
     */
    public static Tree createAntlrAST(String filepath) throws IOException,
    ...
    public static Program createAST(String filepath) throws IOException,
            RecognitionException {
